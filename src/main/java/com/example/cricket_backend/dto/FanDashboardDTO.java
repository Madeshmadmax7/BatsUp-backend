...
public class FanDashboardDTO {
    ...
    public List<NewsLetter> getFollowedTeamNews() {
        return followedTeamNews;
    }

    public void setFollowedTeamNews(List<NewsLetter> followedTeamNews) {
        this.followedTeamNews = followedTeamNews;
    }

    public List<NewsLetter> getOtherNews() {
        return otherNews;
    }

    public void setOtherNews(List<NewsLetter> otherNews) {
        this.otherNews = otherNews;
    }

    public List<Match> getFollowedTeamMatches() {
        return followedTeamMatches;
    }

    public void setFollowedTeamMatches(List<Match> followedTeamMatches) {
        this.followedTeamMatches = followedTeamMatches;
    }
}
